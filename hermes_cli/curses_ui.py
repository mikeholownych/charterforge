"""Shared curses-based UI components for Charterforge CLI: checklist / radiolist /
single-select menus with keyboard navigation and fuzzy ``/`` search, plus a
numbered text fallback for terminals without curses."""
import sys
