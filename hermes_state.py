...
# Fork callers (gateway/run.py, cron/scheduler.py) import the shared-registry
# API from ``hermes_state``. Upstream's coordinator keeps it in
# hermes_state_registry.py only; re-export the same four symbols this fork's
# callers have always used (real functions from the real registry module).
